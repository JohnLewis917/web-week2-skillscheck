...
// Code Here
const total = myNumbers.reduce((acc, val) => { return acc + val})
//////////////////PROBLEM 17////////////////////
...
// Code Here
const enemies = people.filter((el,i) => people[i].friend === false)
//////////////////PROBLEM 20////////////////////
...
// Code Here
const totallyAwesome = people.reduce((acc, el, i, arr) => {return people[i].awesomeLevel + acc}, 0)